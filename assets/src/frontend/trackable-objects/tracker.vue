<template>
	<div class="stackonet-dashboard-tracker">
		...
		<side-navigation :active="true" :show-overlay="false" nav-width="410px" class="tracker-side-navigation">
...
<script>
	...
	export default {
		name: "tracker",
		components: {MapObjectCard, columns, column, sideNavigation},
