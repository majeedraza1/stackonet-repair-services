...
class PaymentLinkCustomerEmail extends WC_Email {
	...
	public function get_content_html() {
		...
		echo '<a href="' . $payment_url . '" class="button" target="_blank" style="display: inline-block; width: 100%; min-height: 20px; padding: 10px; border-radius: 3px; color: #ffffff; font-size: 15px; line-height: 25px; text-align: center; text-decoration: none; -webkit-text-size-adjust: none;background-color: #f9a73b;">
