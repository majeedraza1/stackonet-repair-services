...
//		return self::haversineCircleDistance( $latitudeFrom, $longitudeFrom, $latitudeTo, $longitudeTo, $earthRadius );
	 ...
	 */
	public static function vincentyCircleDistance( $latitudeFrom, $longitudeFrom, $latitudeTo, $longitudeTo, $earthRadius = 6371000 ) {
	 ...
	 * @return float Distance between points in [m] (same as earthRadius)
	 */
	public static function haversineCircleDistance( $latitudeFrom, $longitudeFrom, $latitudeTo, $longitudeTo, $earthRadius = 6371000 ) {
		// convert from degrees to radians
		$latFrom = deg2rad( $latitudeFrom );
		$lonFrom = deg2rad( $longitudeFrom );
		$latTo   = deg2rad( $latitudeTo );
